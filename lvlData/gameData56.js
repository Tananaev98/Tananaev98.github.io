...
const ENEMY_TYPES = {
 ...
 const bossAbilities = [
	...
	{ boss: 'enem4', type: 'enem44', xPos: 18, yPos: 8,  customHP: 1, customDamage: ENEMY_TYPES.enem4.baseDamage, customSpeed: 18 }, //13 — нежданчик: пузыри разом с обеих сторон без привычного разброса
	...
	{ boss: 'enem4', type: 'enem44', xPos: 35, yPos: 26, customHP: 1, customDamage: ENEMY_TYPES.enem4.baseDamage, customSpeed: 11 }, //21 цепь-B звено 3
	{ boss: 'enem4', type: 'enem44', xPos: 65, yPos: 26, customHP: 1, customDamage: ENEMY_TYPES.enem4.baseDamage, customSpeed: 8 },  //22 цепь-B звено 4
 ...
 const mBossDelayAb = [
	{ boss: 'enem1', bossDelayAb: 310, bossDelayAbDop: 5700 }, // ровное скольжение
	{ boss: 'enem2', bossDelayAb: 220, bossDelayAbDop: 4200 }, // самый частый — быстрые падения-накрытия
	{ boss: 'enem3', bossDelayAb: 415, bossDelayAbDop: 6900 }, // самый долгий отдых — долгое трение
	{ boss: 'enem4', bossDelayAb: 195, bossDelayAbDop: 3500 }, // нервные всплески без пауз
	{ boss: 'enem5', bossDelayAb: 255, bossDelayAbDop: 5100 }, // собранный финал
 ];

 const bossAbilitiesDop = [
	// Скользель — SUDS_SLIDE
	...
	{ boss: 'enem1', indexAbilities: [13, 6, 7] }, // нежданчик: скольжение вдруг разворачивается в обратную сторону
	{ boss: 'enem1', indexAbilities: [0, 1, 2, 3, 4, 14] }, // сигнатурная: полный проезд через всё поле разом

	// Полотнище — SHROUD_DROP
	...
	{ boss: 'enem2', indexAbilities: [0, 1, 5] }, // same-start с [0,1], расходится быстрым падением-накрытием
	{ boss: 'enem2', indexAbilities: [16, 17, 18], isChain: true }, // ← цепь-A (3)
	{ boss: 'enem2', indexAbilities: [19, 20, 21, 22, 23], isChain: true }, // ← цепь-B (5)
	{ boss: 'enem2', indexAbilities: [12, 13] }, // нежданчик: накрытие сразу по центру без привычного разброса
	{ boss: 'enem2', indexAbilities: [0, 2, 4, 6, 8, 14] }, // сигнатурная: сплошной шлейф накрытий через всё поле
	...
	{ boss: 'enem3', indexAbilities: [0, 1, 4] }, // same-start с [0,1], расходится дальним трением
	{ boss: 'enem3', indexAbilities: [16, 17, 18, 19], isChain: true }, // ← цепь-A (4)
	{ boss: 'enem3', indexAbilities: [20, 21, 22, 23], isChain: true }, // ← цепь-B (4)
	{ boss: 'enem3', indexAbilities: [14, 15] }, // нежданчик: хруст раньше привычного долгого трения
	{ boss: 'enem3', indexAbilities: [0, 1, 2, 3, 12, 13] }, // сигнатурная: долгое трение с обеих сторон разом, венчается тяжёлым хрустом

	// Лоханыч — BUBBLE_BURST
	...
	{ boss: 'enem4', indexAbilities: [0, 1, 2] }, // same-start с [0,1], расходится дальним всплеском
	{ boss: 'enem4', indexAbilities: [16, 17, 18], isChain: true }, // ← цепь-A (3)
	{ boss: 'enem4', indexAbilities: [19, 20, 21, 22], isChain: true }, // ← цепь-B (4)
	{ boss: 'enem4', indexAbilities: [13, 14] }, // нежданчик: пузыри разом с обеих сторон без привычного разброса
	{ boss: 'enem4', indexAbilities: [0, 1, 4, 8, 5, 9] }, // сигнатурная: пузыри вскипают по всему краю лохани разом

	// Скрутиха — TOWEL_SNAP, финальный облик
	...
	{ boss: 'enem5', indexAbilities: [0, 1, 3] }, // same-start с [0,1], расходится дальним щелчком
	{ boss: 'enem5', indexAbilities: [16, 17, 18, 19], isChain: true }, // ← цепь-A (4)
	{ boss: 'enem5', indexAbilities: [20, 21, 22, 23, 24, 25], isChain: true }, // ← цепь-B (6, максимум для этого уровня)
	{ boss: 'enem5', indexAbilities: [12, 13] }, // нежданчик: щелчок без единого мгновения закручивания
	{ boss: 'enem5', indexAbilities: [0, 3, 5, 7, 9, 15] }, // сигнатурная кульминация: широкий хлёст через весь двор разом
 ];
