// ПРЕВЬЮ-ЗАГЛУШКА уровня области «Беспокойный двор» — целиком копия gameData1.js
// (Колобок), сменён только lvlNumber. Нужна только чтобы посмотреть, как фон/
// оформление области выглядят в реальном бою. Когда область будет наполняться
// по-настоящему — этот файл нужно заменить уникальным содержимым.
let lvlNumber = 41;
...
const ENEMY_TYPES = {
 ...
 const mBossDelayAb = [
	{ boss: 'enem1', bossDelayAb: 280, bossDelayAbDop: 5200 },
	{ boss: 'enem2', bossDelayAb: 320, bossDelayAbDop: 5600 },
	{ boss: 'enem3', bossDelayAb: 380, bossDelayAbDop: 6400 },
	{ boss: 'enem4', bossDelayAb: 260, bossDelayAbDop: 5000 },
	{ boss: 'enem5', bossDelayAb: 240, bossDelayAbDop: 4800 },
];
