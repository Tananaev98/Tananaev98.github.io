...
const bossCombatConfig = {
	...
	bosses: {
		enem1: { combatIdentity: "Рубка колуна", combatTrick: "повторяет удар в прежнем секторе вместо ожидаемого чередования", signatureEvery: 4, movementStyle: 'accelerate', cadence: 1.06, telegraphMs: 860, speedMultiplier: 0.98, damageMultiplier: 1.02, speedVariance: [0.84, 0.94, 1.04, 1.14, 1.22] }, // LEFT_COLUMN: рубящая вертикаль
		enem2: { combatIdentity: "Покос свистухи", combatTrick: "ведёт прицел вдоль прохода, затем возвращает угрозу за спину прохода", signatureEvery: 4, movementStyle: 'lateRush', cadence: 1.12, telegraphMs: 960, speedMultiplier: 0.90, damageMultiplier: 1.14, speedVariance: [0.80, 0.90, 1.00, 1.10, 1.18] }, // BOTTOM_MOW: коса проходит по низу
		enem3: { combatIdentity: "Захлоп корзины", combatTrick: "сводит угрозы с краёв к внутренним полосам, затем размыкает рисунок", signatureEvery: 4, movementStyle: 'pause', cadence: 0.96, telegraphMs: 780, speedMultiplier: 1.06, damageMultiplier: 1.08, speedVariance: [0.82, 0.94, 1.06, 1.18, 1.26] }, // TWINS_NO_WALL: пары хватают после паузы
		enem4: { combatIdentity: "Пинок лаптя", combatTrick: "двойной выпад иногда получает третий укус с другой стороны", signatureEvery: 4, movementStyle: 'drift', cadence: 0.80, telegraphMs: 600, speedMultiplier: 1.20, damageMultiplier: 1.09, speedVariance: [0.96, 1.06, 1.16, 1.24, 1.30] }, // RIGHT_FLOOD: быстрый поток справа
		enem5: { combatIdentity: "Выброс из носика", combatTrick: "две короткие группы разделены паузой; вторая группа меняет сторону", signatureEvery: 4, movementStyle: 'weave', cadence: 0.74, telegraphMs: 650, speedMultiplier: 1.16, damageMultiplier: 1.18, speedVariance: [0.78, 0.92, 1.06, 1.20, 1.32] } // TOP_DENSE: верхний дождь с рывками
	}
};
...
const bossAbilities = [
    ...
    {boss: "enem1",type: "enem11",xPos: 17,yPos: 12,customHP: 1,customDamage: 27,customSpeed: 16},
    {boss: "enem1",type: "enem11",xPos: 24,yPos: 20,customHP: 1,customDamage: 27,customSpeed: 14},
    {boss: "enem1",type: "enem11",xPos: 80,yPos: 6,customHP: 1,customDamage: 27,customSpeed: 21},
    {boss: "enem1",type: "enem11",xPos: 17,yPos: 40,customHP: 1,customDamage: 27,customSpeed: 7},
    {boss: "enem1",type: "enem11",xPos: 17,yPos: 8,customHP: 1,customDamage: 27,customSpeed: 20},
    {boss: "enem1",type: "enem11",xPos: 68,yPos: 12,customHP: 1,customDamage: 27,customSpeed: 18},
    {boss: "enem2",type: "enem22",xPos: 85,yPos: 12,customHP: 1,customDamage: 29.7,customSpeed: 16},
    {boss: "enem2",type: "enem22",xPos: 68,yPos: 20,customHP: 1,customDamage: 29.7,customSpeed: 14},
    {boss: "enem2",type: "enem22",xPos: 36,yPos: 6,customHP: 1,customDamage: 29.7,customSpeed: 21},
    {boss: "enem2",type: "enem22",xPos: 85,yPos: 40,customHP: 1,customDamage: 29.7,customSpeed: 7},
    {boss: "enem2",type: "enem22",xPos: 85,yPos: 8,customHP: 1,customDamage: 29.7,customSpeed: 20},
    {boss: "enem2",type: "enem22",xPos: 15,yPos: 12,customHP: 1,customDamage: 29.7,customSpeed: 18},
    {boss: "enem3",type: "enem33",xPos: 22,yPos: 12,customHP: 1,customDamage: 32.4,customSpeed: 16},
    {boss: "enem3",type: "enem33",xPos: 34,yPos: 20,customHP: 1,customDamage: 32.4,customSpeed: 14},
    {boss: "enem3",type: "enem33",xPos: 80,yPos: 6,customHP: 1,customDamage: 32.4,customSpeed: 21},
    {boss: "enem3",type: "enem33",xPos: 22,yPos: 40,customHP: 1,customDamage: 32.4,customSpeed: 7},
    {boss: "enem3",type: "enem33",xPos: 22,yPos: 8,customHP: 1,customDamage: 32.4,customSpeed: 20},
    {boss: "enem3",type: "enem33",xPos: 66,yPos: 12,customHP: 1,customDamage: 32.4,customSpeed: 18},
    {boss: "enem4",type: "enem44",xPos: 76,yPos: 12,customHP: 1,customDamage: 35.1,customSpeed: 16},
    {boss: "enem4",type: "enem44",xPos: 82,yPos: 20,customHP: 1,customDamage: 35.1,customSpeed: 14},
    {boss: "enem4",type: "enem44",xPos: 18,yPos: 6,customHP: 1,customDamage: 35.1,customSpeed: 21},
    {boss: "enem4",type: "enem44",xPos: 76,yPos: 40,customHP: 1,customDamage: 35.1,customSpeed: 7},
    {boss: "enem4",type: "enem44",xPos: 76,yPos: 8,customHP: 1,customDamage: 35.1,customSpeed: 20},
    {boss: "enem4",type: "enem44",xPos: 31,yPos: 12,customHP: 1,customDamage: 35.1,customSpeed: 18},
    {boss: "enem5",type: "enem55",xPos: 14,yPos: 12,customHP: 1,customDamage: 37.8,customSpeed: 16},
    {boss: "enem5",type: "enem55",xPos: 28,yPos: 20,customHP: 1,customDamage: 37.8,customSpeed: 14},
    {boss: "enem5",type: "enem55",xPos: 74,yPos: 6,customHP: 1,customDamage: 37.8,customSpeed: 21},
    {boss: "enem5",type: "enem55",xPos: 14,yPos: 40,customHP: 1,customDamage: 37.8,customSpeed: 7},
    {boss: "enem5",type: "enem55",xPos: 14,yPos: 8,customHP: 1,customDamage: 37.8,customSpeed: 20},
    {boss: "enem5",type: "enem55",xPos: 86,yPos: 12,customHP: 1,customDamage: 37.8,customSpeed: 18}
];


const mBossDelayAb = [
	{ boss: 'enem1', bossDelayAb: 310, bossDelayAbDop: 5700, firstWaveDelayMs: 2400 }, // рубка столбиком, щепки летят часто
	{ boss: 'enem2', bossDelayAb: 290, bossDelayAbDop: 6400, firstWaveDelayMs: 2400 }, // покос медленный, свист резкий
	{ boss: 'enem3', bossDelayAb: 240, bossDelayAbDop: 5100, firstWaveDelayMs: 2400 }, // захваты синхронны, хлопок мгновенный
	{ boss: 'enem4', bossDelayAb: 220, bossDelayAbDop: 4900, firstWaveDelayMs: 2352 }, // топот справа не стихает
	{ boss: 'enem5', bossDelayAb: 190, bossDelayAbDop: 4600, firstWaveDelayMs: 2208 }, // пар густой, клапаны редки
];
...
const bossAbilitiesDop = [
    ...
    {boss: "enem1",indexAbilities: [10,11,12],openingOrder: 0},
    {boss: "enem1",indexAbilities: [10,12,11]},
    {boss: "enem1",indexAbilities: [16,20,17],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Рубка колуна — знакомство",openingOrder: 1},
    {boss: "enem1",indexAbilities: [16,20,18],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Рубка колуна — иной конец"},
    {boss: "enem1",indexAbilities: [21,18,21,17],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Рубка колуна — завершение"},
    {boss: "enem2",indexAbilities: [0,1,2,3,4,5]},
    {boss: "enem2",indexAbilities: [0,2,4],openingOrder: 0},
    {boss: "enem2",indexAbilities: [6,7,8,9]},
    {boss: "enem2",indexAbilities: [10,11,12]},
    {boss: "enem2",indexAbilities: [16,17,18],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Покос свистухи — знакомство",openingOrder: 1},
    {boss: "enem2",indexAbilities: [16,17,20],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Покос свистухи — иной конец"},
    {boss: "enem2",indexAbilities: [21,18,17,20],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Покос свистухи — завершение"},
    {boss: "enem3",indexAbilities: [0,1,2,3]},
    {boss: "enem3",indexAbilities: [0,1,2,3,4,5,6,7]},
    {boss: "enem3",indexAbilities: [8,9],openingOrder: 0},
    {boss: "enem3",indexAbilities: [0,8,1,9]},
    {boss: "enem3",indexAbilities: [16,18,17,21],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Захлоп корзины — знакомство",openingOrder: 1},
    {boss: "enem3",indexAbilities: [16,18,20],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Захлоп корзины — иной конец"},
    {boss: "enem3",indexAbilities: [17,21,16,18],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Захлоп корзины — завершение"},
    {boss: "enem4",indexAbilities: [0,1,2,3,4,5,6,7]},
    {boss: "enem4",indexAbilities: [0,2,4,6]},
    {boss: "enem4",indexAbilities: [10,11,12],openingOrder: 0},
    {boss: "enem4",indexAbilities: [10,12,11]},
    {boss: "enem4",indexAbilities: [16,20],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Пинок лаптя — знакомство",openingOrder: 1},
    {boss: "enem4",indexAbilities: [16,20,18],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Пинок лаптя — иной конец"},
    {boss: "enem4",indexAbilities: [21,17,21,18],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Пинок лаптя — завершение"},
    ...
    {boss: "enem5",indexAbilities: [16,20,18,21],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Выброс из носика — знакомство",openingOrder: 1,shotGapsMs: [360,900,360]},
    {boss: "enem5",indexAbilities: [16,20,21],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Выброс из носика — иной конец",shotGapsMs: [360,900,360]},
    {boss: "enem5",indexAbilities: [18,21,16,20],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Выброс из носика — завершение",shotGapsMs: [360,900,360]}
];
