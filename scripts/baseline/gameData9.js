...
const bossCombatConfig = {
	...
	bosses: {
		enem1: { combatIdentity: "Хлёст крапивы", combatTrick: "показывает боковой замах, но заканчивает серединой; позднее конец возвращается на край", signatureEvery: 4, movementStyle: 'pause', cadence: 0.94, telegraphMs: 740, speedMultiplier: 1.10, damageMultiplier: 1.02, speedVariance: [0.84, 0.96, 1.08, 1.20, 1.30] }, // ALT_WHIP: хлёсткая смена флангов
		enem2: { combatIdentity: "Колючий зацеп", combatTrick: "медленный первый снаряд остаётся фоном для более срочного второго", signatureEvery: 4, movementStyle: 'drift', cadence: 1.02, telegraphMs: 820, speedMultiplier: 1.04, damageMultiplier: 1.08, speedVariance: [0.86, 0.98, 1.10, 1.20, 1.28] }, // CORNERS_BURST: сходится из углов
		enem3: { combatIdentity: "Струя борщевика", combatTrick: "короткий первый заход продолжается более быстрым довеском с прежнего края", signatureEvery: 4, movementStyle: 'straight', cadence: 0.78, telegraphMs: 570, speedMultiplier: 1.22, damageMultiplier: 1.10, speedVariance: [0.94, 1.04, 1.14, 1.24, 1.32] }, // TWIN_JETS_MID: частые ускоряющиеся струи
		enem4: { combatIdentity: "Двойной шип", combatTrick: "двойной выпад иногда получает третий укус с другой стороны", signatureEvery: 4, movementStyle: 'weave', cadence: 0.88, telegraphMs: 680, speedMultiplier: 1.16, damageMultiplier: 1.14, speedVariance: [0.76, 0.90, 1.06, 1.22, 1.34] }, // RIGHT_STABS: колющий выпад справа
		enem5: { combatIdentity: "Обхват лозы", combatTrick: "сводит угрозы с краёв к внутренним полосам, затем размыкает рисунок", signatureEvery: 4, movementStyle: 'lateRush', cadence: 0.80, telegraphMs: 650, speedMultiplier: 1.14, damageMultiplier: 1.20, speedVariance: [0.82, 0.94, 1.06, 1.20, 1.32] } // SEQ_WRAP: пауза между обхватами
	}
};
...
const bossAbilities = [
    ...
    {boss: "enem1",type: "enem11",xPos: 14,yPos: 12,customHP: 1,customDamage: 29,customSpeed: 16},
    {boss: "enem1",type: "enem11",xPos: 28,yPos: 20,customHP: 1,customDamage: 29,customSpeed: 14},
    {boss: "enem1",type: "enem11",xPos: 82,yPos: 6,customHP: 1,customDamage: 29,customSpeed: 21},
    {boss: "enem1",type: "enem11",xPos: 14,yPos: 40,customHP: 1,customDamage: 29,customSpeed: 7},
    {boss: "enem1",type: "enem11",xPos: 14,yPos: 8,customHP: 1,customDamage: 29,customSpeed: 20},
    {boss: "enem1",type: "enem11",xPos: 43,yPos: 12,customHP: 1,customDamage: 29,customSpeed: 18},
    {boss: "enem2",type: "enem22",xPos: 80,yPos: 12,customHP: 1,customDamage: 31.9,customSpeed: 16},
    {boss: "enem2",type: "enem22",xPos: 18,yPos: 20,customHP: 1,customDamage: 31.9,customSpeed: 14},
    {boss: "enem2",type: "enem22",xPos: 64,yPos: 6,customHP: 1,customDamage: 31.9,customSpeed: 21},
    {boss: "enem2",type: "enem22",xPos: 80,yPos: 24,customHP: 1,customDamage: 31.9,customSpeed: 7},
    {boss: "enem2",type: "enem22",xPos: 80,yPos: 8,customHP: 1,customDamage: 31.9,customSpeed: 20},
    {boss: "enem2",type: "enem22",xPos: 32,yPos: 12,customHP: 1,customDamage: 31.9,customSpeed: 18},
    {boss: "enem3",type: "enem33",xPos: 22,yPos: 12,customHP: 1,customDamage: 34.8,customSpeed: 16},
    {boss: "enem3",type: "enem33",xPos: 30,yPos: 20,customHP: 1,customDamage: 34.8,customSpeed: 14},
    {boss: "enem3",type: "enem33",xPos: 76,yPos: 6,customHP: 1,customDamage: 34.8,customSpeed: 21},
    {boss: "enem3",type: "enem33",xPos: 22,yPos: 40,customHP: 1,customDamage: 34.8,customSpeed: 7},
    {boss: "enem3",type: "enem33",xPos: 22,yPos: 8,customHP: 1,customDamage: 34.8,customSpeed: 20},
    {boss: "enem3",type: "enem33",xPos: 86,yPos: 12,customHP: 1,customDamage: 34.8,customSpeed: 18},
    {boss: "enem4",type: "enem44",xPos: 83,yPos: 12,customHP: 1,customDamage: 37.7,customSpeed: 16},
    {boss: "enem4",type: "enem44",xPos: 75,yPos: 20,customHP: 1,customDamage: 37.7,customSpeed: 14},
    {boss: "enem4",type: "enem44",xPos: 20,yPos: 6,customHP: 1,customDamage: 37.7,customSpeed: 21},
    {boss: "enem4",type: "enem44",xPos: 83,yPos: 40,customHP: 1,customDamage: 37.7,customSpeed: 7},
    {boss: "enem4",type: "enem44",xPos: 83,yPos: 8,customHP: 1,customDamage: 37.7,customSpeed: 20},
    {boss: "enem4",type: "enem44",xPos: 38,yPos: 12,customHP: 1,customDamage: 37.7,customSpeed: 18},
    {boss: "enem5",type: "enem55",xPos: 12,yPos: 12,customHP: 1,customDamage: 40.6,customSpeed: 16},
    {boss: "enem5",type: "enem55",xPos: 28,yPos: 20,customHP: 1,customDamage: 40.6,customSpeed: 14},
    {boss: "enem5",type: "enem55",xPos: 86,yPos: 6,customHP: 1,customDamage: 40.6,customSpeed: 21},
    {boss: "enem5",type: "enem55",xPos: 12,yPos: 40,customHP: 1,customDamage: 40.6,customSpeed: 7},
    {boss: "enem5",type: "enem55",xPos: 12,yPos: 8,customHP: 1,customDamage: 40.6,customSpeed: 20},
    {boss: "enem5",type: "enem55",xPos: 68,yPos: 12,customHP: 1,customDamage: 40.6,customSpeed: 18}
];


const mBossDelayAb = [
	{ boss: 'enem1', bossDelayAb: 250, bossDelayAbDop: 5200, firstWaveDelayMs: 2400 }, // плети хлещут по одной
	{ boss: 'enem2', bossDelayAb: 300, bossDelayAbDop: 5900, firstWaveDelayMs: 2400 }, // репей цепляется из углов
	{ boss: 'enem3', bossDelayAb: 210, bossDelayAbDop: 4800, firstWaveDelayMs: 2304 }, // струи брызжут часто
	{ boss: 'enem4', bossDelayAb: 280, bossDelayAbDop: 6000, firstWaveDelayMs: 2400 }, // шипы бьют справа
	{ boss: 'enem5', bossDelayAb: 230, bossDelayAbDop: 5100, firstWaveDelayMs: 2400 }, // лоза обвивает по очереди
];

// Способности: архетип / подмножество / дно / быстрые / микс
const bossAbilitiesDop = [
    {boss: "enem1",indexAbilities: [0,1,2,3,4,5]},
    {boss: "enem1",indexAbilities: [0,2,4,6],openingOrder: 0},
    {boss: "enem1",indexAbilities: [1,3,5,7]},
    {boss: "enem1",indexAbilities: [8,9,10,11]},
    {boss: "enem1",indexAbilities: [16,17,21],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Хлёст крапивы — знакомство",openingOrder: 1},
    {boss: "enem1",indexAbilities: [16,17,20],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Хлёст крапивы — иной конец"},
    {boss: "enem1",indexAbilities: [18,21,17,20],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Хлёст крапивы — завершение"},
    {boss: "enem2",indexAbilities: [0,1,2,3]},
    {boss: "enem2",indexAbilities: [4,5,6,7,8,9]},
    {boss: "enem2",indexAbilities: [0,4,1,5,2,6]},
    {boss: "enem2",indexAbilities: [10,11],openingOrder: 0},
    {boss: "enem2",indexAbilities: [19,18],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Колючий зацеп — знакомство",openingOrder: 1},
    {boss: "enem2",indexAbilities: [19,18,20],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Колючий зацеп — иной конец"},
    {boss: "enem2",indexAbilities: [19,21,18,20],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Колючий зацеп — завершение"},
    ...
    {boss: "enem3",indexAbilities: [19,20,16],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Струя борщевика — знакомство",openingOrder: 1},
    {boss: "enem3",indexAbilities: [19,20,18],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Струя борщевика — иной конец"},
    {boss: "enem3",indexAbilities: [21,17,21,18,16],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Струя борщевика — завершение"},
    {boss: "enem4",indexAbilities: [0,1,2,3,4,5]},
    {boss: "enem4",indexAbilities: [0,2,4,6]},
    {boss: "enem4",indexAbilities: [7,8,9]},
    {boss: "enem4",indexAbilities: [10,11],openingOrder: 0},
    {boss: "enem4",indexAbilities: [16,20],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Двойной шип — знакомство",openingOrder: 1},
    {boss: "enem4",indexAbilities: [16,20,18],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Двойной шип — иной конец"},
    {boss: "enem4",indexAbilities: [21,17,21,18],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Двойной шип — завершение"},
    {boss: "enem5",indexAbilities: [0,2,4,6]},
    {boss: "enem5",indexAbilities: [1,3,5,7]},
    {boss: "enem5",indexAbilities: [8,9],openingOrder: 0},
    {boss: "enem5",indexAbilities: [10,11,12]},
    {boss: "enem5",indexAbilities: [16,18,17,21],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Обхват лозы — знакомство",openingOrder: 1},
    {boss: "enem5",indexAbilities: [16,18,20],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Обхват лозы — иной конец"},
    {boss: "enem5",indexAbilities: [17,21,16,18],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Обхват лозы — завершение"}
];
