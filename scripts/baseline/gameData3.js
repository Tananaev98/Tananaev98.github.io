...
const bossCombatConfig = {
	...
	bosses: {
		enem1: { combatIdentity: "Иглы проводника", combatTrick: "двойной выпад иногда получает третий укус с другой стороны", signatureEvery: 4, movementStyle: 'lateRush', cadence: 0.96, telegraphMs: 800, speedMultiplier: 1.06, damageMultiplier: 0.96, speedVariance: [0.86, 0.96, 1.06, 1.16, 1.24] }, // NEEDLE_BURST: короткие ускоряющиеся иглы
		enem2: { combatIdentity: "Птичья шея", combatTrick: "повторяет удар в прежнем секторе вместо ожидаемого чередования", signatureEvery: 4, movementStyle: 'pause', cadence: 1.02, telegraphMs: 850, speedMultiplier: 1.00, damageMultiplier: 1.01, speedVariance: [0.88, 0.98, 1.07, 1.15, 1.22] }, // RIGHT_HISS: угрозы сползают справа
		enem3: { combatIdentity: "Печной выдох", combatTrick: "две короткие группы разделены паузой; вторая группа меняет сторону", signatureEvery: 4, movementStyle: 'drift', cadence: 1.10, telegraphMs: 970, speedMultiplier: 0.88, damageMultiplier: 1.15, speedVariance: [0.82, 0.91, 1.00, 1.10, 1.18] }, // HEAT_GUST: волнообразные порывы
		enem4: { combatIdentity: "Ветка с яблоками", combatTrick: "ведёт прицел вдоль прохода, затем возвращает угрозу за спину прохода", signatureEvery: 4, movementStyle: 'straight', cadence: 0.92, telegraphMs: 760, speedMultiplier: 1.08, damageMultiplier: 1.06, speedVariance: [0.80, 0.92, 1.05, 1.18, 1.28] }, // DROP_FRUIT: падение → внезапный разгон
		enem5: { combatIdentity: "Вязкий кисель", combatTrick: "медленный первый снаряд остаётся фоном для более срочного второго", signatureEvery: 4, movementStyle: 'weave', cadence: 1.14, telegraphMs: 1040, speedMultiplier: 0.86, damageMultiplier: 1.18, speedVariance: [0.78, 0.88, 0.98, 1.08, 1.16] } // BOTTOM_WALL: вязкая кисельная стена
	}
};
...
const ENEMY_TYPES = {
 ...
 const bossAbilities = [
    ...
    {boss: "enem1",type: "enem11",xPos: 16,yPos: 12,customHP: 1,customDamage: 23,customSpeed: 16},
    {boss: "enem1",type: "enem11",xPos: 22,yPos: 20,customHP: 1,customDamage: 23,customSpeed: 14},
    {boss: "enem1",type: "enem11",xPos: 82,yPos: 6,customHP: 1,customDamage: 23,customSpeed: 21},
    {boss: "enem1",type: "enem11",xPos: 16,yPos: 40,customHP: 1,customDamage: 23,customSpeed: 7},
    {boss: "enem1",type: "enem11",xPos: 16,yPos: 8,customHP: 1,customDamage: 23,customSpeed: 20},
    {boss: "enem1",type: "enem11",xPos: 68,yPos: 12,customHP: 1,customDamage: 23,customSpeed: 18},
    {boss: "enem2",type: "enem22",xPos: 78,yPos: 12,customHP: 1,customDamage: 25.3,customSpeed: 16},
    {boss: "enem2",type: "enem22",xPos: 70,yPos: 20,customHP: 1,customDamage: 25.3,customSpeed: 14},
    {boss: "enem2",type: "enem22",xPos: 22,yPos: 6,customHP: 1,customDamage: 25.3,customSpeed: 21},
    {boss: "enem2",type: "enem22",xPos: 78,yPos: 40,customHP: 1,customDamage: 25.3,customSpeed: 7},
    {boss: "enem2",type: "enem22",xPos: 78,yPos: 8,customHP: 1,customDamage: 25.3,customSpeed: 20},
    {boss: "enem2",type: "enem22",xPos: 34,yPos: 12,customHP: 1,customDamage: 25.3,customSpeed: 18},
    {boss: "enem3",type: "enem33",xPos: 24,yPos: 12,customHP: 1,customDamage: 27.6,customSpeed: 16},
    {boss: "enem3",type: "enem33",xPos: 34,yPos: 20,customHP: 1,customDamage: 27.6,customSpeed: 14},
    {boss: "enem3",type: "enem33",xPos: 72,yPos: 6,customHP: 1,customDamage: 27.6,customSpeed: 21},
    {boss: "enem3",type: "enem33",xPos: 24,yPos: 40,customHP: 1,customDamage: 27.6,customSpeed: 7},
    {boss: "enem3",type: "enem33",xPos: 24,yPos: 8,customHP: 1,customDamage: 27.6,customSpeed: 20},
    {boss: "enem3",type: "enem33",xPos: 82,yPos: 12,customHP: 1,customDamage: 27.6,customSpeed: 18},
    {boss: "enem4",type: "enem44",xPos: 82,yPos: 12,customHP: 1,customDamage: 29.9,customSpeed: 16},
    {boss: "enem4",type: "enem44",xPos: 65,yPos: 20,customHP: 1,customDamage: 29.9,customSpeed: 14},
    {boss: "enem4",type: "enem44",xPos: 35,yPos: 6,customHP: 1,customDamage: 29.9,customSpeed: 21},
    {boss: "enem4",type: "enem44",xPos: 82,yPos: 40,customHP: 1,customDamage: 29.9,customSpeed: 7},
    {boss: "enem4",type: "enem44",xPos: 82,yPos: 8,customHP: 1,customDamage: 29.9,customSpeed: 20},
    {boss: "enem4",type: "enem44",xPos: 14,yPos: 12,customHP: 1,customDamage: 29.9,customSpeed: 18},
    {boss: "enem5",type: "enem55",xPos: 18,yPos: 12,customHP: 1,customDamage: 32.2,customSpeed: 16},
    {boss: "enem5",type: "enem55",xPos: 76,yPos: 20,customHP: 1,customDamage: 32.2,customSpeed: 14},
    {boss: "enem5",type: "enem55",xPos: 30,yPos: 6,customHP: 1,customDamage: 32.2,customSpeed: 21},
    {boss: "enem5",type: "enem55",xPos: 18,yPos: 24,customHP: 1,customDamage: 32.2,customSpeed: 7},
    {boss: "enem5",type: "enem55",xPos: 18,yPos: 8,customHP: 1,customDamage: 32.2,customSpeed: 20},
    {boss: "enem5",type: "enem55",xPos: 66,yPos: 12,customHP: 1,customDamage: 32.2,customSpeed: 18}
];

 const mBossDelayAb = [
	{ boss: 'enem1', bossDelayAb: 300, bossDelayAbDop: 5400, firstWaveDelayMs: 2400 }, // иголки сыплются
	{ boss: 'enem2', bossDelayAb: 280, bossDelayAbDop: 6000, firstWaveDelayMs: 2400 }, // шипение справа
	{ boss: 'enem3', bossDelayAb: 320, bossDelayAbDop: 5600, firstWaveDelayMs: 2400 }, // жар волнами
	{ boss: 'enem4', bossDelayAb: 340, bossDelayAbDop: 6200, firstWaveDelayMs: 2400 }, // плоды падают размеренно
	{ boss: 'enem5', bossDelayAb: 300, bossDelayAbDop: 6800, firstWaveDelayMs: 2400 }, // кисель набирает, долгая пауза
];
 ...
 const bossAbilitiesDop = [
    ...
    {boss: "enem1",indexAbilities: [16,20],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Иглы проводника — знакомство",openingOrder: 1},
    {boss: "enem1",indexAbilities: [16,20,18],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Иглы проводника — иной конец"},
    {boss: "enem1",indexAbilities: [21,17,21,18],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Иглы проводника — завершение"},
    {boss: "enem2",indexAbilities: [0,1,2,3,4,5]},
    {boss: "enem2",indexAbilities: [0,2,4,6],openingOrder: 0},
    {boss: "enem2",indexAbilities: [8,9,10,11]},
    {boss: "enem2",indexAbilities: [8,10,9,11]},
    {boss: "enem2",indexAbilities: [1,8,5,13]},
    {boss: "enem2",indexAbilities: [16,20,17],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Птичья шея — знакомство",openingOrder: 1},
    {boss: "enem2",indexAbilities: [16,20,18],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Птичья шея — иной конец"},
    {boss: "enem2",indexAbilities: [21,18,21,17],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Птичья шея — завершение"},
    ...
    {boss: "enem3",indexAbilities: [16,20,18,21],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Печной выдох — знакомство",openingOrder: 1,shotGapsMs: [360,900,360]},
    {boss: "enem3",indexAbilities: [16,20,21],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Печной выдох — иной конец",shotGapsMs: [360,900,360]},
    {boss: "enem3",indexAbilities: [18,21,16,20],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Печной выдох — завершение",shotGapsMs: [360,900,360]},
    ...
    {boss: "enem4",indexAbilities: [16,17,18],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Ветка с яблоками — знакомство",openingOrder: 1},
    {boss: "enem4",indexAbilities: [16,17,20],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Ветка с яблоками — иной конец"},
    {boss: "enem4",indexAbilities: [21,18,17,20],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Ветка с яблоками — завершение"},
    {boss: "enem5",indexAbilities: [0,1,2,3,4,5,6,7]},
    {boss: "enem5",indexAbilities: [0,2,4,6,8]},
    {boss: "enem5",indexAbilities: [10,11],openingOrder: 0},
    {boss: "enem5",indexAbilities: [8,9,10,11]},
    {boss: "enem5",indexAbilities: [2,10,9,11]},
    {boss: "enem5",indexAbilities: [19,18],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Вязкий кисель — знакомство",openingOrder: 1},
    {boss: "enem5",indexAbilities: [19,18,20],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Вязкий кисель — иной конец"},
    {boss: "enem5",indexAbilities: [19,21,18,20],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Вязкий кисель — завершение"}
];
