...
const bossCombatConfig = {
	...
	bosses: {
		enem1: { signatureEvery: 4, movementStyle: 'pause', cadence: 1.04, telegraphMs: 900, speedMultiplier: 0.96, damageMultiplier: 1.04, speedVariance: [0.80, 0.92, 1.04, 1.16, 1.24] }, // AXE_COLUMNS: тяжёлый замах → удар
		enem2: { signatureEvery: 4, movementStyle: 'drift', cadence: 1.08, telegraphMs: 940, speedMultiplier: 0.90, damageMultiplier: 1.02, speedVariance: [0.82, 0.92, 1.02, 1.12, 1.20] }, // SPORE_CLOUD: плавающее облако
		enem3: { signatureEvery: 4, movementStyle: 'straight', cadence: 0.92, telegraphMs: 700, speedMultiplier: 1.10, damageMultiplier: 1.08, speedVariance: [0.92, 1.00, 1.08, 1.16, 1.22] }, // AIM_PAIRS: точные прямые выстрелы
		enem4: { signatureEvery: 4, movementStyle: 'weave', cadence: 1.12, telegraphMs: 1020, speedMultiplier: 0.86, damageMultiplier: 1.16, speedVariance: [0.80, 0.88, 0.96, 1.04, 1.12] }, // HERD_WALL: медленное смещение стада
		enem5: { signatureEvery: 4, movementStyle: 'accelerate', cadence: 0.82, telegraphMs: 680, speedMultiplier: 1.12, damageMultiplier: 1.14, speedVariance: [0.88, 0.98, 1.08, 1.18, 1.26] } // KEY_PATHS: быстро закрывает пути
	}
};
...
const ENEMY_TYPES = {
 ...
 const mBossDelayAb = [
	{ boss: 'enem1', bossDelayAb: 350, bossDelayAbDop: 5800, firstWaveDelayMs: 2400 },
	{ boss: 'enem2', bossDelayAb: 400, bossDelayAbDop: 6200, firstWaveDelayMs: 2400 },
	{ boss: 'enem3', bossDelayAb: 280, bossDelayAbDop: 5000, firstWaveDelayMs: 2400 },
	{ boss: 'enem4', bossDelayAb: 220, bossDelayAbDop: 6800, firstWaveDelayMs: 2400 },
	{ boss: 'enem5', bossDelayAb: 300, bossDelayAbDop: 5200, firstWaveDelayMs: 2400 },
];
