...
const bossCombatConfig = {
	...
	bosses: {
		enem1: { signatureEvery: 4, movementStyle: 'straight', cadence: 0.96, telegraphMs: 780, speedMultiplier: 1.06, damageMultiplier: 0.99, speedVariance: [0.86, 0.96, 1.06, 1.16, 1.24] }, // ZIGZAG: усиленная змейка
		enem2: { signatureEvery: 4, movementStyle: 'weave', cadence: 1.02, telegraphMs: 850, speedMultiplier: 1.00, damageMultiplier: 1.04, speedVariance: [0.84, 0.94, 1.04, 1.14, 1.22] }, // CORNERS: угрозы выползают из углов
		enem3: { signatureEvery: 4, movementStyle: 'accelerate', cadence: 0.82, telegraphMs: 620, speedMultiplier: 1.18, damageMultiplier: 1.08, speedVariance: [0.92, 1.02, 1.12, 1.22, 1.30] }, // LEFT_SWARM: быстрый пчелиный рой
		enem4: { signatureEvery: 4, movementStyle: 'lateRush', cadence: 1.16, telegraphMs: 1040, speedMultiplier: 0.84, damageMultiplier: 1.20, speedVariance: [0.76, 0.86, 0.96, 1.06, 1.14] }, // BOTTOM_WALL: вязкое болотное давление
		enem5: { signatureEvery: 4, movementStyle: 'pause', cadence: 0.80, telegraphMs: 680, speedMultiplier: 1.13, damageMultiplier: 1.16, speedVariance: [0.80, 0.92, 1.04, 1.18, 1.30] } // MID_ONLY: присасывается после заминки
	}
};
...
const mBossDelayAb = [
	{ boss: 'enem1', bossDelayAb: 340, bossDelayAbDop: 5800, firstWaveDelayMs: 2400 }, // зигзаг — пауза между витками
	{ boss: 'enem2', bossDelayAb: 270, bossDelayAbDop: 6200, firstWaveDelayMs: 2400 }, // паутина натянута, сброс резкий
	{ boss: 'enem3', bossDelayAb: 180, bossDelayAbDop: 4500, firstWaveDelayMs: 2160 }, // рой жужжит без передышки
	{ boss: 'enem4', bossDelayAb: 300, bossDelayAbDop: 6800, firstWaveDelayMs: 2400 }, // болото набирает, долгая пауза
	{ boss: 'enem5', bossDelayAb: 250, bossDelayAbDop: 5400, firstWaveDelayMs: 2400 }, // присоска цепляется ритмично
];
