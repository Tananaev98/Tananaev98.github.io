...
const bossCombatConfig = {
	...
	bosses: {
		enem1: { combatIdentity: "Шляпка и ножка", combatTrick: "две короткие группы разделены паузой; вторая группа меняет сторону", signatureEvery: 4, movementStyle: 'accelerate', cadence: 1.10, telegraphMs: 950, speedMultiplier: 0.90, damageMultiplier: 0.95, speedVariance: [0.82, 0.90, 0.98, 1.06, 1.14] }, // LEFT_COLUMN: ровное давление колонной
		enem2: { combatIdentity: "Тяжёлый бок груздя", combatTrick: "сводит угрозы с краёв к внутренним полосам, затем размыкает рисунок", signatureEvery: 4, movementStyle: 'lateRush', cadence: 0.98, telegraphMs: 820, speedMultiplier: 1.02, damageMultiplier: 1.00, speedVariance: [0.88, 0.97, 1.05, 1.13, 1.20] }, // RIGHT_SPILL: растекается с правого края
		enem3: { combatIdentity: "Кольца рыжика", combatTrick: "разводит две цели, затем закрывает оставленную между ними полосу", signatureEvery: 4, movementStyle: 'pause', cadence: 1.06, telegraphMs: 900, speedMultiplier: 0.96, damageMultiplier: 1.08, speedVariance: [0.84, 0.94, 1.04, 1.14, 1.22] }, // RING_PAIRS: раскачивающиеся пары
		enem4: { combatIdentity: "Длинная ножка", combatTrick: "короткий первый заход продолжается более быстрым довеском с прежнего края", signatureEvery: 4, movementStyle: 'drift', cadence: 0.90, telegraphMs: 710, speedMultiplier: 1.10, damageMultiplier: 1.04, speedVariance: [0.90, 1.00, 1.10, 1.18, 1.24] }, // DUAL_ASCENT: ускоряющийся подъём
		enem5: { combatIdentity: "Лисий край шляпки", combatTrick: "показывает боковой замах, но заканчивает серединой; позднее конец возвращается на край", signatureEvery: 4, movementStyle: 'straight', cadence: 0.80, telegraphMs: 740, speedMultiplier: 1.08, damageMultiplier: 1.12, speedVariance: [0.80, 0.92, 1.04, 1.16, 1.26] } // WAVE_TOP: дождь с поздним рывком
	}
};
...
const ENEMY_TYPES = {
 ...
 const bossAbilities = [
    ...
    {boss: "enem1",type: "enem11",xPos: 16,yPos: 12,customHP: 1,customDamage: 22,customSpeed: 16},
    {boss: "enem1",type: "enem11",xPos: 25,yPos: 20,customHP: 1,customDamage: 22,customSpeed: 14},
    {boss: "enem1",type: "enem11",xPos: 77,yPos: 6,customHP: 1,customDamage: 22,customSpeed: 21},
    {boss: "enem1",type: "enem11",xPos: 16,yPos: 40,customHP: 1,customDamage: 22,customSpeed: 7},
    {boss: "enem1",type: "enem11",xPos: 16,yPos: 8,customHP: 1,customDamage: 22,customSpeed: 20},
    {boss: "enem1",type: "enem11",xPos: 85,yPos: 12,customHP: 1,customDamage: 22,customSpeed: 18},
    {boss: "enem2",type: "enem22",xPos: 84,yPos: 12,customHP: 1,customDamage: 24.2,customSpeed: 16},
    {boss: "enem2",type: "enem22",xPos: 70,yPos: 20,customHP: 1,customDamage: 24.2,customSpeed: 14},
    {boss: "enem2",type: "enem22",xPos: 14,yPos: 6,customHP: 1,customDamage: 24.2,customSpeed: 21},
    {boss: "enem2",type: "enem22",xPos: 84,yPos: 40,customHP: 1,customDamage: 24.2,customSpeed: 7},
    {boss: "enem2",type: "enem22",xPos: 84,yPos: 8,customHP: 1,customDamage: 24.2,customSpeed: 20},
    {boss: "enem2",type: "enem22",xPos: 30,yPos: 12,customHP: 1,customDamage: 24.2,customSpeed: 18},
    {boss: "enem3",type: "enem33",xPos: 24,yPos: 12,customHP: 1,customDamage: 26.4,customSpeed: 16},
    {boss: "enem3",type: "enem33",xPos: 47,yPos: 20,customHP: 1,customDamage: 26.4,customSpeed: 14},
    {boss: "enem3",type: "enem33",xPos: 72,yPos: 6,customHP: 1,customDamage: 26.4,customSpeed: 21},
    {boss: "enem3",type: "enem33",xPos: 24,yPos: 40,customHP: 1,customDamage: 26.4,customSpeed: 7},
    {boss: "enem3",type: "enem33",xPos: 24,yPos: 8,customHP: 1,customDamage: 26.4,customSpeed: 20},
    {boss: "enem3",type: "enem33",xPos: 47,yPos: 12,customHP: 1,customDamage: 26.4,customSpeed: 18},
    {boss: "enem4",type: "enem44",xPos: 80,yPos: 12,customHP: 1,customDamage: 28.6,customSpeed: 16},
    {boss: "enem4",type: "enem44",xPos: 76,yPos: 20,customHP: 1,customDamage: 28.6,customSpeed: 14},
    {boss: "enem4",type: "enem44",xPos: 19,yPos: 6,customHP: 1,customDamage: 28.6,customSpeed: 21},
    {boss: "enem4",type: "enem44",xPos: 80,yPos: 40,customHP: 1,customDamage: 28.6,customSpeed: 7},
    {boss: "enem4",type: "enem44",xPos: 80,yPos: 8,customHP: 1,customDamage: 28.6,customSpeed: 20},
    {boss: "enem4",type: "enem44",xPos: 30,yPos: 12,customHP: 1,customDamage: 28.6,customSpeed: 18},
    {boss: "enem5",type: "enem55",xPos: 18,yPos: 12,customHP: 1,customDamage: 30.8,customSpeed: 16},
    {boss: "enem5",type: "enem55",xPos: 32,yPos: 20,customHP: 1,customDamage: 30.8,customSpeed: 14},
    {boss: "enem5",type: "enem55",xPos: 84,yPos: 6,customHP: 1,customDamage: 30.8,customSpeed: 21},
    {boss: "enem5",type: "enem55",xPos: 18,yPos: 40,customHP: 1,customDamage: 30.8,customSpeed: 7},
    {boss: "enem5",type: "enem55",xPos: 18,yPos: 8,customHP: 1,customDamage: 30.8,customSpeed: 20},
    {boss: "enem5",type: "enem55",xPos: 47,yPos: 12,customHP: 1,customDamage: 30.8,customSpeed: 18}
];

 const mBossDelayAb = [
	{ boss: 'enem1', bossDelayAb: 340, bossDelayAbDop: 5800, firstWaveDelayMs: 2400 }, // толстый, размеренный
	{ boss: 'enem2', bossDelayAb: 280, bossDelayAbDop: 6200, firstWaveDelayMs: 2400 }, // разлив плотный
	{ boss: 'enem3', bossDelayAb: 300, bossDelayAbDop: 5400, firstWaveDelayMs: 2400 }, // круги вспыхивают
	{ boss: 'enem4', bossDelayAb: 260, bossDelayAbDop: 5600, firstWaveDelayMs: 2400 }, // подъём по ножке
	{ boss: 'enem5', bossDelayAb: 220, bossDelayAbDop: 4800, firstWaveDelayMs: 2304 }, // волна сыплется часто
];
 ...
 const bossAbilitiesDop = [
    ...
    {boss: "enem1",indexAbilities: [16,20,18,21],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Шляпка и ножка — знакомство",openingOrder: 1,shotGapsMs: [360,900,360]},
    {boss: "enem1",indexAbilities: [16,20,21],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Шляпка и ножка — иной конец",shotGapsMs: [360,900,360]},
    {boss: "enem1",indexAbilities: [18,21,16,20],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Шляпка и ножка — завершение",shotGapsMs: [360,900,360]},
    {boss: "enem2",indexAbilities: [0,1,2,3,4,5,6]},
    {boss: "enem2",indexAbilities: [0,2,4,7],openingOrder: 0},
    {boss: "enem2",indexAbilities: [8,9,10,11]},
    {boss: "enem2",indexAbilities: [8,10,9,11]},
    {boss: "enem2",indexAbilities: [1,8,5,13]},
    {boss: "enem2",indexAbilities: [16,18,17,21],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Тяжёлый бок груздя — знакомство",openingOrder: 1},
    {boss: "enem2",indexAbilities: [16,18,20],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Тяжёлый бок груздя — иной конец"},
    {boss: "enem2",indexAbilities: [17,21,16,18],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Тяжёлый бок груздя — завершение"},
    {boss: "enem3",indexAbilities: [0,1,2,3,4,5]},
    {boss: "enem3",indexAbilities: [0,1,6,7]},
    {boss: "enem3",indexAbilities: [8,9,10],openingOrder: 0},
    {boss: "enem3",indexAbilities: [8,10,9,13]},
    {boss: "enem3",indexAbilities: [2,8,3,9]},
    {boss: "enem3",indexAbilities: [16,18,21],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Кольца рыжика — знакомство",openingOrder: 1},
    {boss: "enem3",indexAbilities: [16,18,17],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Кольца рыжика — иной конец"},
    {boss: "enem3",indexAbilities: [20,18,21,17],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Кольца рыжика — завершение"},
    {boss: "enem4",indexAbilities: [0,1,2,3]},
    {boss: "enem4",indexAbilities: [4,5,6,7]},
    {boss: "enem4",indexAbilities: [0,1,2,3,4,5,6,7]},
    {boss: "enem4",indexAbilities: [8,9],openingOrder: 0},
    {boss: "enem4",indexAbilities: [0,8,4,9]},
    {boss: "enem4",indexAbilities: [19,20,16],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Длинная ножка — знакомство",openingOrder: 1},
    {boss: "enem4",indexAbilities: [19,20,18],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Длинная ножка — иной конец"},
    {boss: "enem4",indexAbilities: [21,17,21,18,16],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Длинная ножка — завершение"},
    ...
    {boss: "enem5",indexAbilities: [16,17,21],signature: true,minPhase: 1,shotDelayMs: 360,recoveryMs: 650,label: "Лисий край шляпки — знакомство",openingOrder: 1},
    {boss: "enem5",indexAbilities: [16,17,20],signature: true,minPhase: 2,shotDelayMs: 360,recoveryMs: 650,label: "Лисий край шляпки — иной конец"},
    {boss: "enem5",indexAbilities: [18,21,17,20],signature: true,minPhase: 3,shotDelayMs: 360,recoveryMs: 950,label: "Лисий край шляпки — завершение"}
];
