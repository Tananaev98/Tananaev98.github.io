...
const bossCombatConfig = {
	...
	bosses: {
		enem1: { signatureEvery: 4, movementStyle: 'drift', cadence: 0.98, telegraphMs: 760, speedMultiplier: 1.08, damageMultiplier: 1.04, speedVariance: [0.84, 0.96, 1.08, 1.20, 1.30] }, // CLIMB_UP: ускоряется по мере подъёма
		enem2: { signatureEvery: 4, movementStyle: 'straight', cadence: 0.86, telegraphMs: 640, speedMultiplier: 1.16, damageMultiplier: 1.08, speedVariance: [0.74, 0.90, 1.06, 1.22, 1.36] }, // SPARSE_HOPS: редкий прыжок → рывок
		enem3: { signatureEvery: 4, movementStyle: 'weave', cadence: 1.20, telegraphMs: 980, speedMultiplier: 0.86, damageMultiplier: 1.26, speedVariance: [0.76, 0.86, 0.96, 1.06, 1.16] }, // BOTTOM_DENSE: вязкое плотное дно
		enem4: { signatureEvery: 4, movementStyle: 'accelerate', cadence: 0.82, telegraphMs: 600, speedMultiplier: 1.20, damageMultiplier: 1.12, speedVariance: [0.94, 1.04, 1.14, 1.24, 1.32] }, // H_PAIRS_MID: режущие пары меняют траекторию
		enem5: { signatureEvery: 4, movementStyle: 'pause', cadence: 0.74, telegraphMs: 630, speedMultiplier: 1.18, damageMultiplier: 1.20, speedVariance: [0.90, 1.02, 1.14, 1.26, 1.34] } // UNEVEN_REEDS: асимметричные камыши
	}
};
...
const mBossDelayAb = [
	{ boss: 'enem1', bossDelayAb: 330, bossDelayAbDop: 5900, firstWaveDelayMs: 2400 }, // тина ползёт вверх
	{ boss: 'enem2', bossDelayAb: 240, bossDelayAbDop: 5100, firstWaveDelayMs: 2400 }, // кочки прыгают редко
	{ boss: 'enem3', bossDelayAb: 350, bossDelayAbDop: 6500, firstWaveDelayMs: 2400 }, // приманки — плотная стена
	{ boss: 'enem4', bossDelayAb: 260, bossDelayAbDop: 5400, firstWaveDelayMs: 2400 }, // лезвия режут парами
	{ boss: 'enem5', bossDelayAb: 280, bossDelayAbDop: 5600, firstWaveDelayMs: 2400 }, // тростник неровный
];
