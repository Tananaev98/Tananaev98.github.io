...
const tot={};
for(const n of only){
  const lv=(()=>{const fs=require("fs"),vm=require("vm");const src=fs.readFileSync(process.env.BEF+"/gameData"+n+"_before_v3.js","utf8");const sb={};new vm.Script(src+"
this.bossCombatConfig=bossCombatConfig;this.ENEMY_TYPES=ENEMY_TYPES;this.bossAbilities=bossAbilities;this.bossAbilitiesDop=bossAbilitiesDop;this.mBossDelayAb=mBossDelayAb;").runInContext(vm.createContext(sb));return sb;})();
