...
const ENEMY_TYPES = {
 ...
 const bossAbilities = [
	...
	{ boss: 'enem2', type: 'enem22', xPos: 80, yPos: 39, customHP: 1, customDamage: ENEMY_TYPES.enem2.baseDamage, customSpeed: 13 }, // 27 i
	{ boss: 'enem2', type: 'enem22', xPos: 88, yPos: 52, customHP: 1, customDamage: ENEMY_TYPES.enem2.baseDamage, customSpeed: 10 }, // 28 i
	{ boss: 'enem2', type: 'enem22', xPos: 24, yPos: 51, customHP: 1, customDamage: ENEMY_TYPES.enem2.baseDamage, customSpeed: 12 }, // 29 i
 ...
 const bossAbilitiesDop = [
	// Побегайчик: УШИ
	{ boss: 'enem1', indexAbilities: [0, 1], label: "Заячий шажок" },
	{ boss: 'enem1', indexAbilities: [2, 3, 4], label: "Прыжок туда, обратно и снова" },
	{ boss: 'enem1', indexAbilities: [5, 6, 7, 8], signature: true, minPhase: 1, label: "Уши — знакомство: три быстрые лапы справа, ухо слева прилетает последним" },
	{ boss: 'enem1', indexAbilities: [9, 10, 11, 12], label: "Скачок справа, два слева и снова справа" },
	{ boss: 'enem1', indexAbilities: [5, 6, 7, 8, 13], signature: true, minPhase: 2, label: "Уши — иной конец: пятая лапа падает между лапами и ухом" },
	{ boss: 'enem1', indexAbilities: [14, 15, 16, 17, 18, 19], minPhase: 3, label: "Левая очередь из пяти и тяжёлое ухо справа" },
	{ boss: 'enem1', indexAbilities: [20, 21, 22], label: "Справа, слева, справа" },
	{ boss: 'enem1', indexAbilities: [23, 24, 25, 26, 27], minPhase: 2, label: "Пять прыжков: лево, право, лево, право, лево" },

	// Любитель бочков: ЗАГОН
	{ boss: 'enem2', indexAbilities: [0, 1], label: "Клык слева, клык справа" },
	{ boss: 'enem2', indexAbilities: [2, 3, 4], label: "Два слева, один справа" },
	{ boss: 'enem2', indexAbilities: [5, 6, 7, 8, 9], signature: true, minPhase: 1, label: "Загон — знакомство: центр закрыт заранее, фланги гонят в стороны" },
	{ boss: 'enem2', indexAbilities: [10, 11, 12, 13], minPhase: 2, label: "Маятник: слева, справа, слева и тяжёлый справа" },
	{ boss: 'enem2', indexAbilities: [5, 6, 7, 8, 9, 14], signature: true, minPhase: 2, label: "Загон — иной конец: шестой клык слева, когда центр уже закрыт" },
	{ boss: 'enem2', indexAbilities: [15, 16, 17, 18, 19], minPhase: 3, label: "Загон с другой стороны" },
	{ boss: 'enem2', indexAbilities: [20, 21, 22], label: "Двое справа, потом слева" },
	{ boss: 'enem2', indexAbilities: [23, 24, 25, 26], label: "Пара слева, справа и в центр" },
	{ boss: 'enem2', indexAbilities: [27, 28, 29, 30], label: "Клыки вперемешку" },

	// Косолапый: ДВОЙНАЯ ЛАПА
	{ boss: 'enem3', indexAbilities: [0, 1], label: "Две лапы" },
	{ boss: 'enem3', indexAbilities: [2, 3, 4, 5], label: "Стена: лево, право, центр, право" },
	{ boss: 'enem3', indexAbilities: [6, 7, 8, 9], signature: true, minPhase: 1, label: "Двойная лапа — знакомство: три быстрых слева, тяжёлая лапа справа прилетает последней" },
	{ boss: 'enem3', indexAbilities: [10, 11, 12, 13], label: "Стена из пяти лап, бьют по флангам поочерёдно" },
	{ boss: 'enem3', indexAbilities: [6, 7, 8, 9, 14], signature: true, minPhase: 2, label: "Двойная лапа — иной конец: четвёртый удар справа перед лапой" },
	{ boss: 'enem3', indexAbilities: [15, 16, 17, 18, 19, 20], minPhase: 3, label: "Стена из шести лап через всё поле" },
	{ boss: 'enem3', indexAbilities: [21, 22, 23], label: "Центральная лапа, правая и быстрый удар слева" },
	{ boss: 'enem3', indexAbilities: [24, 25, 26, 27], minPhase: 2, label: "Лапы по краям и середине, два быстрых в придачу" },

	// Сестричка: ЛОЖНЫЙ СЛЕД
	{ boss: 'enem4', indexAbilities: [0, 1, 2], label: "Два следа" },
	{ boss: 'enem4', indexAbilities: [3, 4, 5, 6], label: "След вперемешку" },
	{ boss: 'enem4', indexAbilities: [7, 8, 9, 10, 11], signature: true, minPhase: 1, label: "Ложный след — знакомство: четыре слева, тяжёлый укус справа" },
	{ boss: 'enem4', indexAbilities: [12, 13, 14, 15], label: "Правый укус, два слева и снова справа" },
	{ boss: 'enem4', indexAbilities: [7, 8, 9, 10, 16], signature: true, minPhase: 2, label: "Ложный след — иной конец: ещё один укус слева перед правым" },
	{ boss: 'enem4', indexAbilities: [17, 18, 19, 20, 21, 22], minPhase: 3, label: "Длинный след слева и тяжёлый укус справа" },
	{ boss: 'enem4', indexAbilities: [23, 24, 25], label: "Из центра налево и направо" },
	{ boss: 'enem4', indexAbilities: [26, 27, 28, 29], minPhase: 2, label: "Три справа, потом слева" },

	// Колобок: КРУГ
	{ boss: 'enem5', indexAbilities: [0, 1], label: "Левый бок, правый бок" },
	{ boss: 'enem5', indexAbilities: [2, 3, 4, 5, 6], label: "Пять оборотов вперемешку" },
	{ boss: 'enem5', indexAbilities: [7, 8, 9, 10], signature: true, minPhase: 1, label: "Круг — знакомство: пара слева, пара справа, интервалы сжимаются" },
	{ boss: 'enem5', indexAbilities: [11, 12, 13, 14], label: "Три справа и прыжок влево" },
	{ boss: 'enem5', indexAbilities: [7, 8, 9, 15], signature: true, minPhase: 2, label: "Круг — иной конец: пятый удар падает между парами" },
	{ boss: 'enem5', indexAbilities: [16, 17, 18, 19, 20, 21], minPhase: 3, label: "Полный круг: три слева, два справа и тяжёлый слева" },
	{ boss: 'enem5', indexAbilities: [22, 23, 24, 25], label: "Оборот вперемешку" },
	{ boss: 'enem5', indexAbilities: [26, 27, 28, 29, 30], minPhase: 2, label: "Пять оборотов подряд" },
