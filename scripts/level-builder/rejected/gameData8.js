...
const bossAbilities = [
	...
	{ boss: 'enem5', type: 'enem55', xPos: 26, yPos: 44, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 12 }, // 4 b
	{ boss: 'enem5', type: 'enem55', xPos: 25, yPos: 38, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 13 }, // 5 b
	{ boss: 'enem5', type: 'enem55', xPos: 88, yPos: 34, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 13 }, // 6 b
	{ boss: 'enem5', type: 'enem55', xPos: 30, yPos: 34, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 12 }, // 7 b
	...
	{ boss: 'enem5', type: 'enem55', xPos: 10, yPos: 54, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 12 }, // 17 e
	{ boss: 'enem5', type: 'enem55', xPos: 26, yPos: 54, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 12 }, // 18 f
	{ boss: 'enem5', type: 'enem55', xPos: 27, yPos: 54, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 11 }, // 19 f
	{ boss: 'enem5', type: 'enem55', xPos: 15, yPos: 50, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 13 }, // 20 f
	{ boss: 'enem5', type: 'enem55', xPos: 9, yPos: 49, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 13 }, // 21 f
	{ boss: 'enem5', type: 'enem55', xPos: 77, yPos: 52, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 11 }, // 22 f
	{ boss: 'enem5', type: 'enem55', xPos: 6, yPos: 26, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 12 }, // 23 g
	{ boss: 'enem5', type: 'enem55', xPos: 71, yPos: 26, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 12 }, // 24 g
	{ boss: 'enem5', type: 'enem55', xPos: 69, yPos: 21, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 13 }, // 25 g
	{ boss: 'enem5', type: 'enem55', xPos: 86, yPos: 21, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 13 }, // 26 g
	{ boss: 'enem5', type: 'enem55', xPos: 88, yPos: 54, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 12 }, // 27 h
	{ boss: 'enem5', type: 'enem55', xPos: 21, yPos: 51, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 11 }, // 28 h
	{ boss: 'enem5', type: 'enem55', xPos: 5, yPos: 40, customHP: 1, customDamage: ENEMY_TYPES.enem5.baseDamage, customSpeed: 13 }, // 29 h
...
const bossAbilitiesDop = [
	// Жарёныш
	{ boss: 'enem1', indexAbilities: [0, 1, 2], label: "Жар слева, справа и снова слева" },
	{ boss: 'enem1', indexAbilities: [3, 4, 5, 6, 7], label: "Справа, слева, справа, слева и справа" },
	{ boss: 'enem1', indexAbilities: [8, 9, 10, 11], signature: true, minPhase: 1, label: "Жар — знакомство: жар слева, медленная остуда справа, ещё жар слева и в центр" },
	{ boss: 'enem1', indexAbilities: [12, 13, 14, 15, 16], label: "Центр, справа, слева, центр и снова слева" },
	{ boss: 'enem1', indexAbilities: [8, 9, 10, 11, 17], signature: true, minPhase: 2, label: "Жар — иной конец: после жара слева и центра ещё удар справа" },
	{ boss: 'enem1', indexAbilities: [18, 19, 20, 21, 22, 23], minPhase: 3, label: "Жар то слева, то справа, медленная остуда слева и центр" },
	{ boss: 'enem1', indexAbilities: [24, 25, 26], label: "Центр, слева и справа" },
	{ boss: 'enem1', indexAbilities: [27, 28, 29], minPhase: 2, label: "Справа, центр и слева" },

	// Скользыш
	{ boss: 'enem2', indexAbilities: [0, 1, 2, 3], label: "Крайняя полоса слева и справа по очереди" },
	{ boss: 'enem2', indexAbilities: [4, 5, 6, 7], label: "Справа, слева, справа и в центр" },
	{ boss: 'enem2', indexAbilities: [8, 9, 10, 11], signature: true, minPhase: 1, label: "Скольжение — знакомство: полоса слева и полоса справа" },
	{ boss: 'enem2', indexAbilities: [12, 13, 14, 15], label: "Центр, полоса справа, слева и центр" },
	{ boss: 'enem2', indexAbilities: [8, 9, 10, 16], signature: true, minPhase: 2, label: "Скольжение — иной конец: после полосы справа уходит в центр и снова влево" },
	{ boss: 'enem2', indexAbilities: [17, 18, 19, 20, 21], minPhase: 3, label: "Справа, слева, центр, слева и справа" },
	{ boss: 'enem2', indexAbilities: [22, 23, 24, 25], label: "Слева, справа, центр и справа" },
	{ boss: 'enem2', indexAbilities: [26, 27, 28, 29], minPhase: 2, label: "Справа, центр, слева и справа" },

	// Буханка
	{ boss: 'enem3', indexAbilities: [0, 1, 2], label: "Тяжёлый справа, слева и справа" },
	{ boss: 'enem3', indexAbilities: [3, 4, 5, 6], label: "Тяжёлый слева, пара справа и слева" },
	{ boss: 'enem3', indexAbilities: [7, 8, 9, 10], signature: true, minPhase: 1, label: "Каравай — знакомство: тяжёлый справа, пара слева быстрее него и справа" },
	{ boss: 'enem3', indexAbilities: [11, 12, 13, 14, 15], label: "Справа, центр, слева, справа и слева" },
	{ boss: 'enem3', indexAbilities: [7, 8, 9, 16], signature: true, minPhase: 2, label: "Каравай — иной конец: после пар боков удар в центр" },
	{ boss: 'enem3', indexAbilities: [17, 18, 19, 20, 21], minPhase: 3, label: "Тяжёлый слева, пара справа, слева и центр" },
	{ boss: 'enem3', indexAbilities: [22, 23, 24, 25], label: "Справа, слева и дважды справа" },
	{ boss: 'enem3', indexAbilities: [26, 27, 28, 29, 30], minPhase: 2, label: "Центр, справа и дважды слева" },

	// Катёныш
	{ boss: 'enem4', indexAbilities: [0, 1, 2, 3], label: "Слева, справа, центр и слева всё чаще" },
	{ boss: 'enem4', indexAbilities: [4, 5, 6, 7], label: "Справа, слева, центр и снова слева" },
	{ boss: 'enem4', indexAbilities: [8, 9, 10, 11], signature: true, minPhase: 1, label: "Разгон — знакомство: три слева всё чаще и удар справа" },
	{ boss: 'enem4', indexAbilities: [12, 13, 14, 15], label: "Центр, справа, центр и слева" },
	{ boss: 'enem4', indexAbilities: [8, 9, 10, 11, 16], signature: true, minPhase: 2, label: "Разгон — иной конец: после удара справа ещё центр" },
	{ boss: 'enem4', indexAbilities: [17, 18, 19, 20, 21], minPhase: 3, label: "Слева и справа по очереди, темп всё выше" },
	{ boss: 'enem4', indexAbilities: [22, 23, 24, 25], label: "Центр, слева, справа и в центр" },
	{ boss: 'enem4', indexAbilities: [26, 27, 28, 29], minPhase: 2, label: "Справа, слева, справа и слева" },

	// Щелкун
	{ boss: 'enem5', indexAbilities: [0, 1, 2, 3], label: "Три щелчка слева и выстрел в центр" },
	{ boss: 'enem5', indexAbilities: [4, 5, 6, 7], label: "Два щелчка слева, справа и центр" },
	{ boss: 'enem5', indexAbilities: [8, 9, 10, 11, 12], signature: true, minPhase: 1, label: "Щелчки — знакомство: три слева, выстрел в центр и справа" },
	{ boss: 'enem5', indexAbilities: [13, 14, 15, 16], label: "Три щелчка в центр и выстрел слева" },
	{ boss: 'enem5', indexAbilities: [8, 9, 10, 17], signature: true, minPhase: 2, label: "Щелчки — иной конец: после трёх слева выстрел справа и снова слева" },
	{ boss: 'enem5', indexAbilities: [18, 19, 20, 21, 22], minPhase: 3, label: "Три слева и два выстрела справа" },
	{ boss: 'enem5', indexAbilities: [23, 24, 25, 26], label: "Два щелчка в центр, слева и справа" },
	{ boss: 'enem5', indexAbilities: [27, 28, 29], minPhase: 2, label: "Слева и два справа" },
